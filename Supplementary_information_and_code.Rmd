...
To bolster student participation, an extra credit assignment is offered as a group assignment and students collectively read a journal article, navigated NCBI’s BLAST website @altschul_basic_1990, and ultimately identified the bacteria in a simulated unknown skin bacterium sample. Though the students did not perform isolation and sequencing, the activity allowed them for greater understanding of 16S bacterial signatures and the confidence with which they could identify a species. Ideally, future iterations of this assignment will include collecting skin samples and using Nanopore sequencing for students interested in the wet-lab components required to generate data.
