...
Have you conducted microbiome research, previously or currently? (1 = yes)

```{r}
do_col_plot("done_research") & scale_y_continuous(limits = c(0, 1), oob = scales::oob_squish) 
```

Do you, or others at your institution, offer specific courses or educational programs for students related to microbiomes? (1 = yes)

```{r}
do_col_plot("offer_courses") & scale_y_continuous(limits = c(0, 1), oob = scales::oob_squish)
```
